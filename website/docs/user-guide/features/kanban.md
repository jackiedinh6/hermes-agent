...
| `kanban_attach_path` | Attach a file that already exists on disk (preferred for artifacts you wrote — no hand base64, no detour through a URL). Must resolve inside the task workspace. | `path` |
